...
FIX_NATASHA_SPELLS_LEARNING_LEVEL:  equ 1       ; NATASHA's base class is wrongfully treated as promoted for the purpose of learning spells.
...
SHOW_ALL_SPELLS_IN_MEMBER_SCREEN:   equ 1       ; 
